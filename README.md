...
## Information
> I R F A N B O T adalah bot yang awalnya memakai base dari [Chikabot](https://github.com/rashidsiregar28/chikabot/blob/main/README.md), sekarang pindah base [Hisoka-Morou](https://github.com/DikaArdnt/Hisoka-Morou). I R F A N B O T is a bot whatsapp using a Baileys library.
...
## For Windows/RDP
```bash
git clone https://github.com/Irfanbotwa/Irfanbotwa.git
cd Alp
npm install
node main
```
